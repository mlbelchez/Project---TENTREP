        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(activity_signup.this, "Account Successfully Created ", Toast.LENGTH_SHORT).show();
                            finish();
                            startActivity(new Intent(getApplicationContext(), nav_forum.class));
                        }else{
                            Toast.makeText(activity_signup.this, "Account Could not registered.. Please try again", Toast.LENGTH_LONG).show();
                        }
